        ...
        extends AbstractTestTrinoFileSystem
{
            ...
            throws IOException
    {
        ...
        assertThat(cache.isCached(cacheKeyProvider.getCacheKey(inputFile).orElseThrow(), inputFile.length())).isFalse();
        ...
        assertThat(cache.isCached(cacheKeyProvider.getCacheKey(inputFile).orElseThrow(), inputFile.length())).isTrue();
        getFileSystem().deleteFile(location);
    }
