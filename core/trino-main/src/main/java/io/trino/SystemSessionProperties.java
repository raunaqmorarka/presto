...
import io.trino.execution.buffer.CompressionKind;
        ...
        implements SystemSessionPropertiesProvider
{
    ...
    public static final String COMPRESSION_KIND = "compression_kind";
            ...
            NodeSchedulerConfig nodeSchedulerConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                enumProperty(
                        COMPRESSION_KIND,
                        "Compression kind in exchanges and page serializations",
                        CompressionKind.class,
                        featuresConfig.getCompressionKind(),
                        false),
                booleanProperty(
    ...
    public static CompressionKind getCompressionKind(Session session)
    {
        return session.getSystemProperty(COMPRESSION_KIND, CompressionKind.class);
    }
