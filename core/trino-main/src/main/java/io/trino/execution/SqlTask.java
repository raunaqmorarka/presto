...
public class SqlTask
{
    ...
    public TaskInfo updateTask(Session session, Optional<PlanFragment> fragment, List<TaskSource> sources, OutputBuffers outputBuffers, OptionalInt totalPartitions, Map<PlanNodeId, DynamicFilterUpdate> dynamicFilter)
    {
        try {
            ...
            if (taskExecution != null) {
                ...
                taskExecution.addDynamicFilter(dynamicFilter);
            }
        }
        catch (Error e) {
            failed(e);
