...
import static io.trino.SystemSessionProperties.getCompressionKind;
        ...
        context.addDriverFactory(
                ...
                new PhysicalOperation(
                        outputOperatorFactory.createOutputOperator(
                                ...
                                outputTypes,
                                pagePreprocessor,
                                new PagesSerdeFactory(plannerContext.getBlockEncodingSerde(), isExchangeCompressionEnabled(session), getCompressionKind(session))),
                        physicalOperation),
                context);
