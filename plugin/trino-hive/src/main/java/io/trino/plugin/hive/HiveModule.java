...
import io.trino.plugin.hive.util.ConsistentHashingNodeProvider;
        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        binder.bind(NodeProvider.class).to(ConsistentHashingNodeProvider.class).in(Scopes.SINGLETON);
